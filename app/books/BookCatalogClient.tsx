        ...
        <div className="grid gap-5 p-5 md:grid-cols-[16rem_1fr] md:p-5">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
              ...
              {canEdit && !activeLoan && !hasActiveReservations && (
                <form action={deleteMyBookCopyAction}>
                  <input type="hidden" name="bookCopyId" value={copy.id} />
                  <ConfirmSubmitButton
                    confirmMessage={`Confirma excluir definitivamente "${copy.book.title}" do catálogo?`}
                    pendingLabel="Excluindo..."
                    className="w-full rounded-xl border border-red-400/50 px-4 py-2 font-semibold text-red-300 hover:bg-red-500/10 disabled:cursor-not-allowed disabled:border-slate-700 disabled:text-slate-500 sm:w-fit"
                  >
                    Excluir livro
                  </ConfirmSubmitButton>
                </form>
